...
/**
 * Cette classe définie une heuristique basée sur le nombre contrainte
 *
 */
public class NbConstraintsVariableHeuristic implements VariableHeuristic {
    ...
    /**
     * Creer une instance de NbConstraintsVariableHeuristic
     * @param contraintes un ensemble de contraintes
     * @param isPreferable un boolean, vrai si on préfère les variables avec le plus grand domaine, faux dans le cas contraire
     */
